...
class MyFrame extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == sub) {
            ...
            if (term.isSelected()) {
                ...
                // Display entered data in the output area
                ...
                insertUserData(name, mobile, gender, dob, address);
            } else {
                tout.setText("");
                resadd.setText("");
    ...
    private void insertUserData(String name, String mobile, String gender, String dob, String address) {
        ...
        try {
            ...
            String query = "INSERT INTO user_info (name, mobile, gender, dob, address) VALUES (1, 2, 3, 4, 5)";
            ...
            res.setText("SQL Error: " + ex.getMessage());
        }
    }
